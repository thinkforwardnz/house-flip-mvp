...
const PropertyAnalysis = () => {
  ...
  if (isLoading) {
    return (
      <div className="w-full max-w-sm sm:max-w-2xl lg:max-w-4xl mx-auto px-2 sm:px-4 space-y-3 sm:space-y-4">
  ...
  return (
    <div className="w-full max-w-sm sm:max-w-2xl lg:max-w-4xl mx-auto px-2 sm:px-4 space-y-3 sm:space-y-4">
      ...
      <div className="mb-4 sm:mb-6">
        <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-1">Property Analysis</h1>
            ...
            <Card className="bg-white shadow-lg rounded-2xl border-0">
              <CardContent className="p-4 sm:p-6 text-center">
                ...
                <Button 
                  ...
                  className="bg-blue-primary hover:bg-blue-600 text-white rounded-xl px-3 sm:px-4 py-2 text-xs sm:text-sm"
                >
