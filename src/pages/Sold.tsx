...
const Sold = () => {
  ...
  const { selectedDeal, selectedDealId, selectDeal, isLoading } = useSelectedDeal('Sold');
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="bg-blue-50 p-4 rounded-xl">
              ...
              <p className="text-xl font-bold text-blue-800">
                {selectedDeal.purchase_price && selectedDeal.current_profit 
                  ? `${((selectedDeal.current_profit / selectedDeal.purchase_price) * 100).toFixed(1)}%`
                  : 'N/A'
                }
              </p>
            </div>
