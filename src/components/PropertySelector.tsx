...
const PropertySelector = ({
  ...
  if (isLoading) {
    return <Card className="bg-white shadow-lg rounded-2xl border-0 mb-6">
  ...
  return <Card className="bg-white shadow-lg rounded-2xl border-0 mb-6">
      <CardContent className="p-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {currentDeal ? <div className="flex items-center gap-2">
                  ...
                  </div> : <p className="text-navy-dark">No property selected</p>}
              </div>
            </div>
          </div>

          {stageDeals.length > 1 && <DropdownMenu>
              ...
              <DropdownMenuContent className="w-80">
                {stageDeals.map(deal => <DropdownMenuItem key={deal.id} onClick={() => onDealSelect(deal.id)} className={`p-4 cursor-pointer ${deal.id === currentDealId ? 'bg-blue-50' : ''}`}>
                    <div className="flex flex-col gap-1 w-full">
                      ...
                      {deal.purchase_price && <div className="text-sm text-gray-500">
        ...
        {currentDeal && <div className="mt-4 pt-4 border-t border-gray-100">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
              ...
              {currentDeal.purchase_price && <div>
              ...
              {currentDeal.target_sale_price && <div>
              ...
              {currentDeal.current_profit && <div>
